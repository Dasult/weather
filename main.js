...
let infoTitle = document.querySelector('.info-weather__title')
...
button.addEventListener('click', (e) => {
    ...
    fetch(`https://api.openweathermap.org/data/2.5/weather?q=${input.value}&appid=0d54e2c99f5135987d576129179b6bf1`)
        ...
        .then((resolve) => {
            ...
            img.src = `http://openweathermap.org/img/wn/${resolve.weather[0]["icon"]}@2x.png`;
            ...
            if (resolve.weather[0]["main"] === "Clouds") {
                ...
                tempStatus.textContent = "Янсое небо"
            ...
            humadity.textContent = `${resolve.main.humidity}%`
